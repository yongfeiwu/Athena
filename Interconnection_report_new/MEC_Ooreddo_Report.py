...
exeSql = '''
create table tmp_mec_ooredoo_report as
SELECT PK.PK_STIME,
...
AND SUBSTR(M.TERM_NUM, 0, 5) in ( '95996','95997','95995') and (substr(m.org_num,0,5) in ('95930','95931','95932','95933','95934','95936') or substr(m.org_num,0,6) in ('959340','959346','959349'))
...
AND SUBSTR(M.TERM_NUM, 0, 5) in ( '95996','95997','95995')
and (substr(m.org_num,0,5) in ('95930','95931','95932','95933','95934','95936')
or substr(m.org_num,0,6) in ('959340','959346','959349'))
AND M.REID BETWEEN 1249 AND 1252
GROUP BY TRUNC(M.START_TIME)) OP ON PK.PK_STIME = OP.OP_SDATE
LEFT JOIN (SELECT TRUNC(M.START_TIME) SMS_SDATE, COUNT(*) SMS_CNT
/*+parallel(m, 8) */
FROM RECON_IB_CDR_67 M
WHERE SUBSTR(M.TERM_NUM, 0, 5) in ( '95996','95997','95995')
and (substr(m.org_num,0,5) in ('95930','95931','95932','95933','95934','95936')
or substr(m.org_num,0,6) in ('959340','959346','959349'))
AND M.REID >= 1253
GROUP BY TRUNC(M.START_TIME)) SMS ON SMS.SMS_SDATE =
             OP.OP_SDATE
...
print "==========================tmp_mec_ooredoo_report finished =========================="
curs.close()
conn.close()
