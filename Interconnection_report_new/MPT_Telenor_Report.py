...
exeSql = '''
Create table tmp_mpt_telenor_report as
SELECT PK.PK_STIME,
...
AND SUBSTR(M.TERM_NUM, 0, 5) in ( '95979','95978','95977','95976')   and substr(m.org_num,0,4)<>'9593'
...
/*+parallel(m, 8) */
FROM RECON_IB_CDR_67 M
WHERE SUBSTR(M.TERM_NUM, 0, 5) in ( '95979','95978','95977','95976')  and substr(m.org_num,0,4)<>'9593'
AND M.REID >= 1253
...
print "==========================tmp_mpt_telenor_report finished =========================="
curs.close()
conn.close()
