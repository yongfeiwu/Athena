...
exeSql = '''
create table tmp_telenor_mpt_report as
SELECT PK.PK_STIME,
...
/*+parallel(m, 8) */
FROM RECON_IB_CDR_73 M
WHERE SUBSTR(TO_CHAR(M.START_TIME, 'yyyymmddhh24miss'), 9, 2) BETWEEN '08' AND '17'
AND SUBSTR(M.Org_Num, 0, 5) in ( '95979','95978','95976','95977')
...
/*+parallel(m, 8) */
FROM RECON_IB_CDR_73 M
WHERE SUBSTR(M.Org_Num, 0, 5) in ( '95979','95978','95976','95977')
and SUBSTR(M.Term_Num, 0, 6)<>'959593'
AND M.REID >= 1253
...
print "==========================tmp_telenor_mpt_report finished =========================="
curs.close()
conn.close()
