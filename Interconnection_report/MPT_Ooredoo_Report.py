...
exeSql = '''
create table tmp_mpt_ooredoo_report as
SELECT PK.PK_STIME,
...
AND SUBSTR(M.TERM_NUM, 0, 5) in ( '95996','95997','95995') and substr(m.org_num,0,4)<>'9593'
...
/*+parallel(m, 8) */
FROM RECON_IB_CDR_67 M
WHERE SUBSTR(M.TERM_NUM, 0, 5) in ( '95996','95997','95995') and substr(m.org_num,0,4)<>'9593'
AND M.REID >= 1253
...
print "==========================tmp_mpt_ooredoo_report finished =========================="
curs.close()
conn.close()
