...
exeSql = '''
create table tmp_mod_ooredoo_report as
SELECT PK.PK_STIME,
...
AND SUBSTR(M.TERM_NUM, 0, 5) in ( '95996','95997','95995')    and ( substr(m.org_num,0,5) in ('95939'))
...
/*+parallel(m, 8) */
from RECON_IB_CDR_67 M
WHERE SUBSTR(M.TERM_NUM, 0, 5) in ( '95996','95997','95995') and ( substr(m.org_num,0,5) in ('95939'))
AND M.REID >= 1253
...
print "==========================tmp_mod_ooredoo_report finished =========================="
curs.close()
conn.close()
