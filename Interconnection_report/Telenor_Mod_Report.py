...
exeSql = '''
create table tmp_telenor_mod_report as
SELECT PK.PK_STIME,
...
AND SUBSTR(M.ORG_NUM, 0, 5) in ('95979', '95978', '95977' , '95976') and ( substr(m.term_num,0,5) in ('95939'))
...
('95979', '95978', '95977' , '95976') and ( substr(m.term_num,0,5) in ('95939'))
and substr(m.term_num,0,6)<>'959593'
AND M.REID BETWEEN 1249 AND 1252
...
print "==========================tmp_telenor_mod_report finished =========================="
curs.close()
conn.close()
