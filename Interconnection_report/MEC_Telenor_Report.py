...
exeSql = '''
create table tmp_mec_telenor_report as
SELECT PK.PK_STIME,
...
AND SUBSTR(M.TERM_NUM, 0, 5) in ( '95979','95978','95977','95976')   and (substr(m.org_num,0,5) in ('95930','95931','95932','95933','95934','95936') or substr(m.org_num,0,6) in ('959340','959346','959349'))
...
/*+parallel(m, 8) */
FROM RECON_IB_CDR_67 M
WHERE SUBSTR(M.TERM_NUM, 0, 5) in ( '95979','95978','95977','95976')  and (substr(m.org_num,0,5) in ('95930','95931','95932','95933','95934','95936') or substr(m.org_num,0,6) in ('959340','959346','959349'))
AND M.REID >= 1253
...
print "==========================tmp_mec_telenor_report finished =========================="
curs.close()
conn.close()
